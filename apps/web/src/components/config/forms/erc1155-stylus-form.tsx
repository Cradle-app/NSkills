...
// All available ERC1155 functions
const ALL_FUNCTIONS = ['balance_of', 'balance_of_batch', 'set_approval_for_all', 'is_approved_for_all', 'safe_transfer_from', 'safe_batch_transfer_from'];
...
export function ERC1155StylusForm({ nodeId, config }: Props) {
  ...
  const functionMeta = getAvailableFunctions('erc1155-stylus');
