    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          placeholder="0x..."
          className="w-full px-3 py-2 bg-forge-bg border border-forge-border/50 rounded-lg text-xs text-white placeholder-forge-muted focus:outline-none focus:border-violet-500/50"
        />
      </div>
