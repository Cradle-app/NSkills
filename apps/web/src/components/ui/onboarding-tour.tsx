...
const DEFAULT_STEPS: TourStep[] = [
    {
        ...
        description: 'Cradle helps you build Web3 projects visually. Let\'s take a quick tour of the interface.',
        icon: Sparkles,
    },
    {
        id: 'palette',
        title: 'Component Palette',
        description: 'Drag components from here onto the canvas. We have contracts, payments, agents, and more.',
    ...
    },
    {
        id: 'canvas',
        title: 'Visual Canvas',
        description: 'This is where you design your project. Connect nodes to define relationships between components.',
    ...
    },
    {
        ...
        description: 'Click on any node to configure it. Each component has customizable settings.',
    ...
    },
    {
        id: 'search',
        title: 'Quick Search',
        description: 'Press Cmd+K (or Ctrl+K) to quickly search and add components to your canvas.',
        icon: Command,
    },
    {
        id: 'generate',
        title: 'Generate Code',
        description: 'When ready, click Generate to create your project. We\'ll push it to GitHub for you!',
