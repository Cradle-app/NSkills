...
export const PLUGIN_REGISTRY: Record<string, PluginRegistryEntry> = {
  ...
  'bnb-lottery-contract': {
    ...
    description: 'Interact with a deployed Lottery.sol contract on BNB Smart Chain Testnet',
    icon: 'Ticket',
    logoAsset: 'BNB Chain.png',
    color: 'node-contracts',
    category: 'contracts',
  ...
  'crowdfunding-contract': {
    ...
    description: 'Interact with a deployed CrowdfundingDApp.sol contract on BNB Smart Chain Testnet',
    icon: 'Heart',
    logoAsset: 'BNB Chain.png',
    color: 'node-contracts',
    category: 'contracts',
    tags: ['crowdfunding', 'fundraising', 'bnb', 'testnet', 'contract'],
    compatibility: {
      compatibleWith: ['frontend-scaffold', 'wallet-auth'],
      suggestedWith: ['rpc-provider', 'bounty-board-contract'],
      requires: [],
    },
    defaultConfig: {
  ...
  'bounty-board-contract': {
    ...
    description: 'Interact with a deployed BountyBoard.sol contract on BNB Smart Chain Testnet',
    icon: 'ClipboardList',
    logoAsset: 'BNB Chain.png',
    color: 'node-contracts',
    category: 'contracts',
    tags: ['bounty', 'rewards', 'tasks', 'bnb', 'testnet', 'contract'],
    compatibility: {
      compatibleWith: ['frontend-scaffold', 'wallet-auth'],
      suggestedWith: ['rpc-provider', 'crowdfunding-contract'],
      requires: [],
    },
    defaultConfig: {
