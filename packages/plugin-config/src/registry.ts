...
export const PLUGIN_REGISTRY: Record<string, PluginRegistryEntry> = {
  ...
  "stylus-contract": {
    ...
    defaultConfig: {
      ...
      contractInstructions:
        "Describe your contract logic here. For example: a simple counter with increment and decrement, or a vending machine with cooldowns.",
    },
  },
  "stylus-zk-contract": {
  ...
  "aixbt-indigo": {
    ...
    defaultConfig: {
      model: "indigo-mini",
      systemPrompt:
        "You are a professional market researcher provided by AIXBT.",
